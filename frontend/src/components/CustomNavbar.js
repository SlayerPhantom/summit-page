...
import { AppBar, Toolbar, Menu, MenuItem, IconButton, Typography, Link, Button} from '@material-ui/core';
    ...
    <ThemeProvider theme={theme}>
      <AppBar position="static">
        <Toolbar>
          ...
          <Link variant="h6" underline='none' style={linkStyle} href="/Speakers">
            Speakers
          </Link>
